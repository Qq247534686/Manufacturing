...
{ 
    ...
    /// SqlServer数据访问帮助类 
    /// </summary> 
    public sealed class MicrosoftSqlHelper 
    { 
        #region 私有构造函数和方法

        private MicrosoftSqlHelper() { }
        ...
        {
            return ConfigurationManager.ConnectionStrings["EMS_DataBase"].ConnectionString;
        } 
        /// <summary> 
        /// 一个有效的数据库连接对象 
        /// </summary> 
        ...
        { 
            SqlConnection Connection = new SqlConnection(MicrosoftSqlHelper.GetConnSting()); 
            return Connection; 
        } 
        #endregion
        ...
        { 
            ...
            { 
                ...
                return MicrosoftSqlHelper.ExecuteNonQuery(connectionString, CommandType.StoredProcedure, spName, commandParameters); 
            } 
            else 
            { 
                return MicrosoftSqlHelper.ExecuteNonQuery(connectionString, CommandType.StoredProcedure, spName); 
            } 
        }
        ...
        { 
            ...
            { 
                ...
                return MicrosoftSqlHelper.ExecuteNonQuery(connection, CommandType.StoredProcedure, spName, commandParameters); 
            } 
            else 
            { 
                return MicrosoftSqlHelper.ExecuteNonQuery(connection, CommandType.StoredProcedure, spName); 
            } 
        }
        ...
        { 
            ...
            { 
                ...
                return MicrosoftSqlHelper.ExecuteNonQuery(transaction, CommandType.StoredProcedure, spName, commandParameters); 
            } 
            else 
            { 
                return MicrosoftSqlHelper.ExecuteNonQuery(transaction, CommandType.StoredProcedure, spName); 
            } 
        } 
        #endregion
        ...
        { 
            ...
            { 
                ...
                return MicrosoftSqlHelper.ExecuteDataset(connectionString, CommandType.StoredProcedure, spName, commandParameters); 
            } 
            else 
            { 
                return MicrosoftSqlHelper.ExecuteDataset(connectionString, CommandType.StoredProcedure, spName); 
            } 
        }
        ...
        { 
            ...
            { 
                ...
                return MicrosoftSqlHelper.ExecuteDataset(connection, CommandType.StoredProcedure, spName, commandParameters); 
            } 
            else 
            { 
                return MicrosoftSqlHelper.ExecuteDataset(connection, CommandType.StoredProcedure, spName); 
            } 
        }
        ...
        { 
            ...
            { 
                ...
                return MicrosoftSqlHelper.ExecuteDataset(transaction, CommandType.StoredProcedure, spName, commandParameters); 
            } 
            else 
            { 
                return MicrosoftSqlHelper.ExecuteDataset(transaction, CommandType.StoredProcedure, spName); 
            } 
        }
        ...
        { 
            ...
            { 
                ...
                return MicrosoftSqlHelper.ExecuteReader(connectionString, CommandType.StoredProcedure, spName, commandParameters); 
            } 
            else 
            { 
                return MicrosoftSqlHelper.ExecuteReader(connectionString, CommandType.StoredProcedure, spName); 
            } 
        }
        ...
        { 
            ...
            { 
                ...
                return MicrosoftSqlHelper.ExecuteReader(connection, CommandType.StoredProcedure, spName, commandParameters); 
            } 
            else 
            { 
                return MicrosoftSqlHelper.ExecuteReader(connection, CommandType.StoredProcedure, spName); 
            } 
        }
        ...
        { 
            ...
            { 
                ...
                return MicrosoftSqlHelper.ExecuteReader(transaction, CommandType.StoredProcedure, spName, commandParameters); 
            } 
            else 
            { 
                return MicrosoftSqlHelper.ExecuteReader(transaction, CommandType.StoredProcedure, spName); 
            } 
        } 
        #endregion
        ...
        { 
            ...
            { 
                ...
                return MicrosoftSqlHelper.ExecuteScalar(connectionString, CommandType.StoredProcedure, spName, commandParameters); 
            } 
            else 
            { 
                return MicrosoftSqlHelper.ExecuteScalar(connectionString, CommandType.StoredProcedure, spName); 
            } 
        }
        ...
        { 
            ...
            { 
                ...
                return MicrosoftSqlHelper.ExecuteScalar(connection, CommandType.StoredProcedure, spName, commandParameters); 
            } 
            else 
            { 
                return MicrosoftSqlHelper.ExecuteScalar(connection, CommandType.StoredProcedure, spName); 
            } 
        }
        ...
        { 
            ...
            { 
                ...
                return MicrosoftSqlHelper.ExecuteScalar(transaction, CommandType.StoredProcedure, spName, commandParameters); 
            } 
            else 
            { 
                return MicrosoftSqlHelper.ExecuteScalar(transaction, CommandType.StoredProcedure, spName); 
            } 
        } 
        #endregion
        ...
        { 
            ...
            { 
                ...
                return MicrosoftSqlHelper.ExecuteXmlReader(connection, CommandType.StoredProcedure, spName, commandParameters); 
            } 
            else 
            { 
                return MicrosoftSqlHelper.ExecuteXmlReader(connection, CommandType.StoredProcedure, spName); 
            } 
        }
        ...
        { 
            ...
            { 
                ...
                return MicrosoftSqlHelper.ExecuteXmlReader(transaction, CommandType.StoredProcedure, spName, commandParameters); 
            } 
            else 
            { 
                return MicrosoftSqlHelper.ExecuteXmlReader(transaction, CommandType.StoredProcedure, spName); 
            } 
        } 
        #endregion
