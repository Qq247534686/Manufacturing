...
{
    public partial class ServiceTheInfo : MetroAppForm
    {
        public ServiceTheInfo()
        {
            InitializeComponent();
        }
        B_GetMethod b_GetMethod = new B_GetMethod();
        private void ServiceTheInfo_Load(object sender, EventArgs e)
        {
            GetTable();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if (string.IsNullOrEmpty(textBox1.Text) || string.IsNullOrEmpty(textBox2.Text) || string.IsNullOrEmpty(textBox4.Text))
            {
                ...
                ToastNotification.Show(this, @"客户代码，客户信息，录入员不能为空！！！", BLL.B_GetMethod.ReadImageFile(@"../../Images/Error.png"), 2000, eToastGlowColor.Red, eToastPosition.MiddleCenter);
                return;
            }
            M_ProductInformation m_ProductInformation = new M_ProductInformation();
            m_ProductInformation.productName = textBox1.Text;
            m_ProductInformation.customerInformation = textBox2.Text;
            m_ProductInformation.dataEntryStaff = textBox4.Text;
            m_ProductInformation.entryTime = dateTimePicker1.Value;
            string img = string.Empty;
            string returnInfo = b_GetMethod.ServiceInfo(m_ProductInformation, M_SQLType.Insert);
            GetTable();
            img = returnInfo.Equals("客户【" + m_ProductInformation.productName + "】添加成功") ? @"../../Images/success.png" : @"../../Images/Error.png";
            ToastNotification.CustomGlowColor = Color.FromArgb(48, 32, 22);
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            string img = string.Empty;
            string returnInfo = b_GetMethod.ServiceInfo(m_ProductInformation, M_SQLType.Delete);
            GetTable();
        ...
        private void GetTable()
        {
            ...
            dt = b_GetMethod.GetTable("[T_ServiceInfo]", "[id],[clientCode] as 客户代码,[customerInformation] as 客户信息,[dataEntryStaff] as 录入员,[entryTime] as 录入时间");
            dataGridView1.DataSource = dt;
            dataGridView1.Columns["客户代码"].ReadOnly = true;
            dataGridView1.Columns["客户信息"].ReadOnly = true;
